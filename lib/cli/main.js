...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-crown create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-crown add wallet-service');
      console.log('    $ bitcore-node-crown add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-crown remove wallet-service');
      console.log('    $ bitcore-node-crown remove insight-api');
      console.log();
    });
