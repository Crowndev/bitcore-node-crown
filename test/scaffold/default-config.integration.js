  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.bitcore-crown/data',
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.bitcore-crown/bitcore-node-crown.json');
    ...
    info.path.should.equal(home + '/.bitcore-crown');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.bitcore-crown/data');
